      ...
      <section className="bg-gradient-to-br from-qcc-blue to-qcc-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <p className="text-lg sm:text-xl text-blue-100 max-w-2xl mx-auto mb-8">
            Explore learning pathways, complete learning items, and earn badges to enhance your teaching practice.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center p-6">
            ...
            <h3 className="text-lg font-semibold text-qcc-dark dark:text-white mb-2">Self-Paced Learning</h3>
            <p className="text-qcc-gray dark:text-gray-400 text-sm">
              Complete interactive modules and resources on your own schedule.
            </p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <h3 className="text-lg font-semibold text-qcc-dark dark:text-white mb-2">Learning Pathways</h3>
            <p className="text-qcc-gray dark:text-gray-400 text-sm">
          ...
          <div className="text-center p-6">
            ...
            <h3 className="text-lg font-semibold text-qcc-dark dark:text-white mb-2">Earn Badges</h3>
            <p className="text-qcc-gray dark:text-gray-400 text-sm">
