...
export default function CourseForm({ course }: CourseFormProps) {
  ...
  const handleDelete = async () => {
    if (!isEditing || !confirm('Are you sure you want to delete this learning item?')) return;
    setLoading(true);
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-2xl space-y-5">
      ...
      <div>
        <label className="block text-sm font-medium text-qcc-dark dark:text-slate-100 mb-1">Short Description</label>
        <input
          type="text"
      ...
      <div>
        <label className="block text-sm font-medium text-qcc-dark dark:text-slate-100 mb-1">Full Description</label>
        <textarea
      ...
      <div>
        <label className="block text-sm font-medium text-qcc-dark dark:text-slate-100 mb-1">
          External URL <span className="text-qcc-gray dark:text-gray-400 font-normal">(link to content)</span>
        </label>
        <input
          type="url"
      ...
      <div>
        <label className="block text-sm font-medium text-qcc-dark dark:text-slate-100 mb-1">
          Image URL <span className="text-qcc-gray dark:text-gray-400 font-normal">(optional)</span>
        </label>
        <input
          type="url"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-qcc-dark dark:text-slate-100 mb-1">Estimated Minutes</label>
          <input
            type="number"
      ...
      <div>
        <label className="block text-sm font-medium text-qcc-dark dark:text-slate-100 mb-1">
          Tags <span className="text-qcc-gray dark:text-gray-400 font-normal">(comma-separated)</span>
        </label>
        <input
          type="text"
          value={form.tags}
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <label htmlFor="is_published" className="text-sm font-medium text-qcc-dark dark:text-slate-100">Published</label>
      </div>
